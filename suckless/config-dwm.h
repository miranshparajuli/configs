...
static const char *fonts[]          = { "Terminess Nerd Font Mono:size=26" };
static const char dmenufont[]       = "Terminess Nerd Font Mono:size=24";
...
static const char *colors[][3]      = {
    /* fg              bg         border   */
    [SchemeNorm] = { col_dim_gray,   col_black, col_dark_gray },
