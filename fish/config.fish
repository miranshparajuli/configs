...
alias ff="fastfetch"
alias d="/home/mrijann/.cargo/bin/dysk"
...
alias make-dwm="cd ~/.config/suckless/dwm/ && doas make clean install && cd ~/"
alias make-term="cd ~/.config/suckless/st/ && doas make clean install && cd ~/"
alias make-lock="cd ~/.config/suckless/slock/ && doas make clean install && cd ~/"
alias make-status="cd ~/.config/suckless/slstatus/ && doas make clean install && cd ~/"
